...
AC_DEFUN([AC_COMPILE_STDCXX_0X], [
  ...
  template <typename T>
    ...
    int a;
    decltype(a) b;]], [[]])],[ac_cv_cxx_compile_cxx11_cxx=yes],[ac_cv_cxx_compile_cxx11_cxx=no])
  ...
  template <typename T>
    ...
    int a;
    decltype(a) b;]], [[]])],[ac_cv_cxx_compile_cxx0x_cxx=yes],[ac_cv_cxx_compile_cxx0x_cxx=no])
  CXXFLAGS="$ac_save_CXXFLAGS"
  AC_LANG_RESTORE
  ])
  ...
  template <typename T>
    ...
    int a;
    decltype(a) b;]], [[]])],[ac_cv_cxx_compile_cxx0x_gxx=yes],[ac_cv_cxx_compile_cxx0x_gxx=no])
  CXXFLAGS="$ac_save_CXXFLAGS"
  AC_LANG_RESTORE
  ])
